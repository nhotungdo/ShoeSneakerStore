...
public class XuatExcelTop10ProductControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<QuantitySold> listTop10Product = dao.getTop10SanPhamBanChay();
        ...
        FileOutputStream file=new FileOutputStream("C:\\ExcelShoeSneaker\\"+"top-10-san-pham-ban-chay-"+Integer.toString(randomNum)+".xlsx");
        ...
        for (QuantitySold quantity : listTop10Product) {
        	   for (Product pro : listAllProduct) {
        		   if(quantity.getProductID() == pro.getId()) {
        			   	i=i+1;
             		     ...
             		     cell4.setCellValue(quantity.getQuantity());	
        		   }	
               }
        }
