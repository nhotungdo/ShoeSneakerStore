...
public class XuatExcelTop5EmployeeControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<TotalSalesSpending> listTop5NhanVien = dao.getTop5NhanVien();
        ...
        FileOutputStream file = new FileOutputStream("C:\\ExcelShoeSneaker\\" + "top-5-nhan-vien-" + Integer.toString(randomNum) + ".xlsx");
        ...
        for (TotalSalesSpending top5 : listTop5NhanVien) {
            for (Account acc : listAllAccount) {
                if (top5.getUserID() == acc.getId()) {
                    ...
                    cell3 = row.createCell(3);
                    cell3.setCellValue(top5.getTotalSales());
                }
            }
        }
