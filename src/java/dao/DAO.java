...
public class DAO {
    ...
    public List<QuantitySold> getTop10SanPhamBanChay() {
        List<QuantitySold> list = new ArrayList<>();
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                list.add(new QuantitySold(rs.getInt(1),
                        rs.getInt(2)
                ));
            }
        } catch (Exception e) {
    ...
    public List<TotalSalesSpending> getTop5KhachHang() {
        List<TotalSalesSpending> list = new ArrayList<>();
        String query = "select top(5) *\r\n"
                + "from TotalSalesSpending\r\n"
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                list.add(new TotalSalesSpending(rs.getInt(1),
                        rs.getDouble(2),
                        rs.getDouble(3)
                ));
            }
    ...
    public List<TotalSalesSpending> getTop5NhanVien() {
        List<TotalSalesSpending> list = new ArrayList<>();
        String query = "select top(5) *\r\n"
                + "from TotalSalesSpending\r\n"
    ...
    public List<Invoice> searchByNgayXuat(String date) {
        List<Invoice> list = new ArrayList<>();
        String query = "select * from Invoice\r\n"
                + "where [date] ='" + date + "'";
        try {
...
//            ps.setString(1,date);
    ...
    public TotalSalesSpending checkTongChiTieuBanHangExist(int userID) {

        String query = "select * from TotalSalesSpending where [userID]=?";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            ps.setInt(1, userID);
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                return new TotalSalesSpending(rs.getInt(1),
                        rs.getDouble(2),
                        rs.getDouble(3)
                );
            }
    ...
    public QuantitySold checkSoLuongDaBanExist(int productID) {

        String query = "select * from QuantitySold where productID = ?";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            ps.setInt(1, productID);
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                return new QuantitySold(rs.getInt(1),
                        rs.getInt(2)
                );
            }
        } catch (Exception e) {
...
//
    ...
    public List<Product> get4NewBalanceLast() {
        List<Product> list = new ArrayList<>();
        String query = "select top 4 * from Product\r\n"
                + "where cateID = 3\r\n"
                + "order by id desc";
    ...
    public List<Product> get4GiayKhacLast() {
        List<Product> list = new ArrayList<>();
        String query = "select top 4 * from Product\r\n"
                + "where cateID = 6\r\n"
                + "order by id desc";
    ...
    public List<Product> get4MLBLast() {
        List<Product> list = new ArrayList<>();
        String query = "select top 4 * from Product\r\n"
                + "where cateID = 4\r\n"
                + "order by id desc";
    ...
    public void deleteTongChiTieuBanHangByUserID(String id) {
        String query = "delete from TotalSalesSpending\n"
                + "where [userID] = ?";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
    ...
    public void deleteSoLuongDaBanByProductID(String productID) {
        String query = "delete from QuantitySold where [productID]=?";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            ps.setString(1, productID);
    ...
    public void insertTongChiTieuBanHang(int userID, double tongChiTieu, double tongBanHang) {
        String query = "insert TotalSalesSpending(userID,TongChiTieu,TongBanHang)\r\n"
                + "values(?,?,?)";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
    ...
    public void insertSoLuongDaBan(int productID, int quantity) {
        String query = "insert QuantitySold(productID,quantity)\r\n"
                + "values(?,?)";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
    ...
    public void insertInvoice(int accountID, double total) {
        String query = "insert Invoice(accountID,total,date)\r\n"
                + "values(?,?,?)";
    ...
    public void editTongChiTieu(int accountID, double totalMoneyVAT) {
        String query = "exec dbo.proc_UpdateTotalSpending ?,?";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            ps.setInt(1, accountID);
    ...
    public void editTongBanHang(int sell_ID, double tongTienBanHangThem) {
        String query = "exec dbo.proc_UpdateTotalSales ?,?";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            ps.setInt(1, sell_ID);
   ...
   public List<Invoice> getInvoicesByUserAccount(int accountID) {
    String query = "SELECT maHD, accountID, total, date FROM Invoice WHERE accountID = ?";
