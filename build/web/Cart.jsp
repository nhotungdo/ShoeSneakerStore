<%-- 
    Document   : Cart
    Created on : Mar 18, 2025, 10:38:47 PM
    Author     : MY PC
--%>
...
<html>
    ...
    <body onload="loadTotalMoney()">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                 ...
                                 <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Phí vận chuyển</strong><strong>Free ship</strong></li>
                                    ...
                                    </ul><a href="order" class="btn btn-dark rounded-pill py-2 btn-block text-white">Checkout</a>
                                </div>
                            </div>
                        </div>
        ...
        function loadTotalMoney() {
            $.ajax({
                url: "/ShoeSneakerStore/totalMoneyCart",
