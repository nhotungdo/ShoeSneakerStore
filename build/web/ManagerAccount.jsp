<%-- 
    ...
    Created on : Mar 18, 2025, 11:29:23 PM
    Author     : MY PC
--%>
                                ...
                                <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Là người mua hàng</th>
                    ...
                    <form action="addAccount" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group form-check">
                                ...
                                <label class="form-check-label" for="isSell">Là người mua hàng</label>
                            </div>

                            <div class="form-group form-check">
                                <input name="isAdmin" value="1" type="checkbox" class="form-check-input" id="isAdmin">
                                <label class="form-check-label" for="isAdmin">Là người bán hàng</label>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
